...
void protobuf_AddDesc_problem_2eproto() {
  ...
  ::KemyBuffers::protobuf_AddDesc_dna_2eproto();
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\'\n\007configs\030\002 \003(\0132\026.KemyBuffers.NetConfig"
    "\022*\n\010whiskers\030\003 \001(\0132\030.KemyBuffers.Whisker"
...
void Problem::InitAsDefaultInstance() {
  ...
  whiskers_ = const_cast< ::KemyBuffers::WhiskerTree*>(&::KemyBuffers::WhiskerTree::default_instance());
}
...
void Problem::MergeFrom(const Problem& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_whiskers()) {
      mutable_whiskers()->::KemyBuffers::WhiskerTree::MergeFrom(from.whiskers());
    }
  }
