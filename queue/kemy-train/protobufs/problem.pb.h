...
class Problem : public ::google::protobuf::Message {
 public:
  ...
  inline const ::KemyBuffers::NetConfig& configs(int index) const;
  inline ::KemyBuffers::NetConfig* mutable_configs(int index);
  inline ::KemyBuffers::NetConfig* add_configs();
  inline const ::google::protobuf::RepeatedPtrField< ::KemyBuffers::NetConfig >&
      configs() const;
  inline ::google::protobuf::RepeatedPtrField< ::KemyBuffers::NetConfig >*
      mutable_configs();
  ...
  inline const ::KemyBuffers::WhiskerTree& whiskers() const;
  inline ::KemyBuffers::WhiskerTree* mutable_whiskers();
  inline ::KemyBuffers::WhiskerTree* release_whiskers();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::KemyBuffers::NetConfig > configs_;
  ::KemyBuffers::WhiskerTree* whiskers_;
...
inline const ::KemyBuffers::NetConfig& Problem::configs(int index) const {
  return configs_.Get(index);
}
inline ::KemyBuffers::NetConfig* Problem::mutable_configs(int index) {
  return configs_.Mutable(index);
}
inline ::KemyBuffers::NetConfig* Problem::add_configs() {
  return configs_.Add();
}
inline const ::google::protobuf::RepeatedPtrField< ::KemyBuffers::NetConfig >&
...
inline void Problem::clear_whiskers() {
  if (whiskers_ != NULL) whiskers_->::KemyBuffers::WhiskerTree::Clear();
  clear_has_whiskers();
}
inline const ::KemyBuffers::WhiskerTree& Problem::whiskers() const {
  return whiskers_ != NULL ? *whiskers_ : *default_instance_->whiskers_;
}
inline ::KemyBuffers::WhiskerTree* Problem::mutable_whiskers() {
  set_has_whiskers();
  if (whiskers_ == NULL) whiskers_ = new ::KemyBuffers::WhiskerTree;
  return whiskers_;
}
inline ::KemyBuffers::WhiskerTree* Problem::release_whiskers() {
  clear_has_whiskers();
  ::KemyBuffers::WhiskerTree* temp = whiskers_;
  whiskers_ = NULL;
  return temp;
}
