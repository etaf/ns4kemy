...
void protobuf_AddDesc_answer_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "fig\030\025 \001(\0132\026.KemyBuffers.NetConfig\022-\n\007res"
...
void ThroughputsDelays::InitAsDefaultInstance() {
  config_ = const_cast< ::KemyBuffers::NetConfig*>(&::KemyBuffers::NetConfig::default_instance());
}
...
void ThroughputsDelays::MergeFrom(const ThroughputsDelays& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_config()) {
      mutable_config()->::KemyBuffers::NetConfig::MergeFrom(from.config());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
