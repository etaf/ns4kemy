...
class ThroughputsDelays : public ::google::protobuf::Message {
 public:
  ...
  inline const ::KemyBuffers::NetConfig& config() const;
  inline ::KemyBuffers::NetConfig* mutable_config();
  inline ::KemyBuffers::NetConfig* release_config();
...
inline void ThroughputsDelays::clear_config() {
  if (config_ != NULL) config_->::KemyBuffers::NetConfig::Clear();
  clear_has_config();
}
inline const ::KemyBuffers::NetConfig& ThroughputsDelays::config() const {
  return config_ != NULL ? *config_ : *default_instance_->config_;
}
inline ::KemyBuffers::NetConfig* ThroughputsDelays::mutable_config() {
  set_has_config();
  if (config_ == NULL) config_ = new ::KemyBuffers::NetConfig;
  return config_;
}
inline ::KemyBuffers::NetConfig* ThroughputsDelays::release_config() {
  clear_has_config();
  ::KemyBuffers::NetConfig* temp = config_;
  config_ = NULL;
  return temp;
}
